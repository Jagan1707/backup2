...
app.get('/',(req,res)=>{
    res.send(`<center>
    <img src="https://paydible.com/wp-content/uploads/2018/09/Paypal-banner.png" width = "700">
    <h2>click to buy your product</h2>
    <form action ="paypal/paypal" method="post">
    <input type= "submit" value="PAY NOW" style="background-color:rgb(76, 156, 231);width: 10%; height: 50px; border: 0;" >
    </form></center>`)
})
...
app.post('/paypal', (req, res) => {
    ...
    const create_payment_json = {
      ...
      "redirect_urls": {
          "return_url": "http://localhost:3000/slip2",
